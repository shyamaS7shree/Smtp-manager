...
export default function AutoresponderCampaignCreatePage() {
    ...
    <Card className="border">
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Button asChild variant="secondary" className="bg-sky-500 text-white hover:bg-sky-600">
          <Link href="/campaigns/autoresponders">Cancel</Link>
        </Button>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <Label>Type</Label>
            <Select defaultValue="autoresponder" disabled>
              <SelectTrigger>
                <SelectValue placeholder="Autoresponder" />
              </SelectTrigger>
              <SelectContent>
